  ...
  <main class="p-20">
    ...
    <div class="flex justify-center m-auto w-1/3 mb-20">
      <div class="w-1/2">
        ...
        <input v-model="inputVal" type="text" class="rounded-md w-full bg-yellow-200 pl-2 mt-2">
        <button
          class="bg-blue-300 hover:bg-blue-400 p-2  rounded-md text-white w-full mt-2"
          @click="send"
        >送信
    ...
    <div class="flex justify-center m-auto w-1/3 mb-20">
      <div class="w-1/2">
        ...
        <button
          ...
          :class="flg ?'bg-red-300 hover:bg-red-400 text-white':'bg-gray-300 hover:bg-gray-400 text-black'"
          @click="changeFlg"
        >
    ...
    <div class="flex justify-center m-auto w-1/3 mb-20">
      <div class="w-1/2">
        ...
        <table class="w-full text-left">
          ...
          <tbody>
          <tr class="hover:bg-blue-100" v-for="member of memberList" :key="member.id">
